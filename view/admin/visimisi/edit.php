<?php ob_start();
// Variabel $visimisiItem harus disiapkan oleh controller
// Contoh: $visimisiItem = ['id' => 1, 'visi' => '...', 'misi' => '...'];
?>
...
<div class="flex items-center justify-between mb-4">
    ...
    <a href="index.php?page=admin-visimisi" 
...
<div class="bg-white border border-slate-200 rounded-xl p-4">
    <form method="POST" action="index.php?page=admin-visimisi&action=update" enctype="multipart/form-data" class="space-y-4">

        <input type="hidden" name="id" value="<?= htmlspecialchars($visimisiItem['id']) ?>">
