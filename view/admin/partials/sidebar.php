            ...
            <div id="dropdown-landingPage" class="dropdown-content hidden ml-4 mt-1 space-y-1">
                ...
                <a href="index.php?page=admin-visimisi"
                        class="flex items-center gap-3 p-2 rounded-lg transition-all duration-200 
                            <?= isDropdownItemActive('admin-visimisi') ? 'bg-blue-900 text-white' : 'text-slate-600 hover:bg-slate-100' ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="index.php?page=admin-profil"
                        class="flex items-center gap-3 p-2 rounded-lg transition-all duration-200 
                            <?= isDropdownItemActive('admin-profil') ? 'bg-blue-900 text-white' : 'text-slate-600 hover:bg-slate-100' ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <span>profil</span>
