            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-4">
                    <div class="relative group bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-blue-900 transition-all duration-300 hover:shadow-2xl">
                        ...
                        <?php
                        $cacheBuster = '';
                        if (isset($profilData['updated_at'])) {
                            $cacheBuster = '?v=' . strtotime($profilData['updated_at']);
                        }
                        ?>
                                                <!-- Logo -->
                        <div class="relative z-10 flex flex-col items-center justify-center space-y-6">
                            <img src="/public/<?= htmlspecialchars($profilData['image']) ?><?= $cacheBuster ?>" alt="Gambar Profil Lab" class="w-full max-w-xs h-auto">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        <?= nl2br(htmlspecialchars($visimisiData['visi'] ?? 'Visi belum diatur.')) ?>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                            ...
                            <?= nl2br(htmlspecialchars($visimisiData['misi'] ?? 'Misi belum diatur.')) ?></span>
                    </ul>
                </div>
            </div>
        </div>
